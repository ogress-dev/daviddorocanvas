    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span className="text-black text-4xl font-bold absolute top-4 left-4">6</span>
            <motion.div
              drag={false}
              whileHover={{
                scale: 1.05,
          ...
          <div
            className="absolute flex items-center justify-center"
            style={{
              left: typeof window !== 'undefined' && window.innerWidth < 768 ? '0px' : '-480px',
              top: '640px',
              width: '320px',
              height: '320px',
          ...
          <div
            className="absolute flex items-center justify-center"
            style={{
              left: typeof window !== 'undefined' && window.innerWidth < 768 ? '0px' : '-160px',
              top: '640px',
              width: '320px',
              height: '320px',
              backgroundColor: '#fee2e2',
          ...
          <div
            ...
            style={{
              left: typeof window !== 'undefined' && window.innerWidth < 768 ? '640px' : '800px',
          ...
          <div
            className="absolute flex items-center justify-center"
            style={{
              left: typeof window !== 'undefined' && window.innerWidth < 768 ? '960px' : '1120px',
              top: '640px',
              width: '320px',
              height: '320px',
              backgroundColor: '#f87171',
          ...
          <div
            ...
            style={{
              left: typeof window !== 'undefined' && window.innerWidth < 768 ? '640px' : '160px',
              top: '640px',
              width: '320px',
          ...
          <div
            ...
            style={{
              left: typeof window !== 'undefined' && window.innerWidth < 768 ? '320px' : '480px',
              top: '640px',
              width: '320px',
